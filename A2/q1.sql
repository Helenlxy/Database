...
DROP VIEW IF EXISTS election_with_country CASCADE;
DROP VIEW IF EXISTS alliance CASCADE;
DROP VIEW IF EXISTS country_election_num CASCADE;
...
HAVING count(election_id) >= (country_election_num.election_num * 0.3);
